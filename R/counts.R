...
#' @export
#'
p_clone_counts = function(a, FoI_a, bins=c(1:5, 13), dx=0.1,
                          hhat=1,bday=0, r=1/200,
  ...
  mix = 1:length(meshX)
  Pda = d_clone_density(meshX, a, FoI_a, hhat, bday, r, RBC_par, Fmu_par, Omega_par, pWda)
  Pda = Pda/sum(Pda)
...
#' @export
#'
d_clone_counts = function(a, FoI_a,  bins=1, dx=0.1,
                          hhat=1,bday=0, r=1/200,
                          RBC_par = par_lRBC_static(),
                          Fmu_par=par_Fmu_base(),
                          Omega_par = par_Omega_beta(),
                          pWda=par_Wda_none(),
                          par_sample = par_nb()){
  DP = d_clone_detect(a, FoI_a, hhat, bday, r, RBC_par, Fmu_par, Omega_par, pWda, par_sample)
  PC = p_clone_counts(a, FoI_a, bins, dx, hhat, bday, r, Fmu_par, Omega_par, pWda, par_sample)
...
#' @export
#'
mean_clone_counts = function(a, FoI_a, dx=0.1,
                             hhat=1,bday=0, r=1/200,
                             Fmu_par=par_Fmu_base(),
                             Omega_par = par_Omega_beta(),
                             pWda=par_Wda_none(),
                             par_sample = par_nb()){
  bins = seq(0,7, by=dx)
  PC = d_clone_counts(a, FoI_a, bins, dx, hhat, bday, r, Fmu_par, Omega_par, pWda, par_sample)
  sum(PC$bins*PC$pdf)
}
...
#' @export
#'
p_parasite_counts = function(a, FoI_a, bins=1, dx=0.1,
                     hhat=1,bday=0, r=1/200,
                     RBC_par = par_lRBC_static(),
                     Fmu_par=par_Fmu_base(),
                     Omega_par = par_Omega_beta(),
                     pWda=par_Wda_none(),
                     par_sample = par_nb()){
  moi = meanMoI(a, FoI_a, hhat, bday, r)
  D = d_parasite_detect(a, FoI_a, hhat, bday, r, RBC_par, Fmu_par, Omega_par, pWda, par_sample)
  out= p_clone_counts(a, FoI_a, bins, dx, hhat, bday, r, Fmu_par, Omega_par, pWda, par_sample)
...
#' @export
#'
d_parasite_counts = function(a, FoI_a, bins=1, dx=0.1,
                     hhat=1,bday=0, r=1/200,
                     RBC_par = par_lRBC_static(),
                     Fmu_par=par_Fmu_base(),
                     Omega_par = par_Omega_beta(),
  ...
  moi = meanMoI(a, FoI_a, hhat, bday, r)
  D = d_parasite_detect(a, FoI_a, hhat, bday, r, RBC_par, Fmu_par, Omega_par, pWda, par_sample)
  PC = p_parasite_counts(a, FoI_a, bins, dx, hhat, bday, r, Fmu_par, Omega_par, pWda, par_sample)
  DP = PC$DM
  list(bins=PC$bins, pdf=diff(c(DP, PC$cdf))/(1-DP), detect=DP, cdf=PC$cdf, fullpdf = c(DP, diff(c(DP, PC$cdf))))
}
...
#' @export
#'
mean_parasite_counts = function(a, FoI_a, dx=0.1,
                        hhat=1,bday=0, r=1/200,
                        Fmu_par=par_Fmu_base(),
                        Omega_par = par_Omega_beta(),
                        pWda=par_Wda_none(),
                        par_sample = par_nb()){
  bins = seq(0,7, by = dx)
  PC = d_parasite_counts(a, FoI_a, bins, dx, hhat, bday, r, Fmu_par, Omega_par, pWda, par_sample)
  sum(PC$bins*PC$pdf)
}
