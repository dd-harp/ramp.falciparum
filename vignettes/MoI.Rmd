...
with the boundary condition $z_d(a,0)=h_d(a).$ We note that the age of the host birth cohort sets an upper limit for the parasite cohort, so $0 < \alpha < a$. The solution, which describes density of infections of age $\alpha$ in a host cohort of age $a$, is given by the formula: 
